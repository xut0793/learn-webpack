...
function genElement() {
  ...
  eleBtn.onclick = function() {
    import(/* webpackChunkName: 'math-async' */'./math.js').then((res) => {
...
function genElement() {
  ...
  eleBtn.textContent = `Click me to async load math`
  eleBtn.onclick = function() {
    __webpack_require__.e(/* import() | math-async */ 1).then(__webpack_require__.bind(__webpack_require__, 1)).then((res) => {
      console.log(`异步加载成功`, res)
      eleBtn.textContent = `Click me to async load math: cube(5) = ${res.cube(5)}`
    })
  }
