...
function genElement() {
  ...
  eleBtn.onclick = function() {
    Promise.all(/* import() | async */[__webpack_require__.e(1), __webpack_require__.e(0)]).then(__webpack_require__.bind(__webpack_require__, 2)).then(() => {
      console.log('异步加载成功')
    })
  }
  return eleDiv
...
/******/ 			// return url for filenames based on template
/******/ 			return "css/" + "css-split-merge" + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
