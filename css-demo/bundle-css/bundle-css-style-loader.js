...
__webpack_require__.r(__webpack_exports__);
 ...
 // 即导出 style-loader 的相关 api
 var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
 ...
 // 导出 css-style 处理后的样式字符串
 var _node_modules_css_loader_dist_cjs_js_index_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
...
//定义函数用来判断当前环境是否 旧 IE，即不支持标准全局变量(widow、document)
// 注意这里的函数都是使用闭包函数的一种形式，也称记忆函数，可以避免多次用到时重复判断
...
// 获取html 文档的 head 元素 getTarget(options.insert || 'head')
...
// 定义函数将样式字符串还原成style语法保存到 stylesInDom 数组中
...
__webpack_require__.r(__webpack_exports__);
 ...
 var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
