...
console.log('css', _index_css__WEBPACK_IMPORTED_MODULE_0__.default)
...
function genElement() {
  ...
  eleStyle.textContent = _index_css__WEBPACK_IMPORTED_MODULE_0__.default[0][1]
  document.head.appendChild(eleStyle)

  // const eleBtn = document.createElement('button')
  // eleBtn.textContent = 'async greet Tom'
  // eleBtn.onclick = function() {
  //   import(/* webpackChunkName: "asyncOther" */'./async-other.js').then((res) => {
  //     res.greet('Tom', eleDiv)
  //   })
  // }
